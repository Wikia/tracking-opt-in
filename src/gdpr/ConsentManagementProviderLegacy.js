...
class ConsentManagementProviderLegacy {
    mounted = false;
    ...
    static installStub(gdprAppliesGlobally = false) {
        ...
        ConsentManagementProviderLegacy.addLocatorFrame();
    }
    ...
    static addLocatorFrame() {
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', () => ConsentManagementProviderLegacy.addLocatorFrame());
            return;
        }
    ...
    installStub(...args) {
        return ConsentManagementProviderLegacy.installStub(...args);
    }
...
export default ConsentManagementProviderLegacy;
