...
describe.only('TrackingOptIn', () => {
    ...
    beforeEach(() => {
        ...
        consentManagementProvider.loadVendorList.returns(Promise.resolve());
        consentManagementProvider.isVendorTCFPolicyVersionOutdated.returns(false);
    ...
    //     geoManager.hasGeoCookie.withArgs().returns(true);
    //     consentManagementProvider.hasUserConsent.withArgs().returns(true);
    //
    //     trackingOptIn.render();
    //
    //     assert.isNotOk(modalIsShown());
